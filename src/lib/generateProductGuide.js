...
export const generateProductGuide = async (link) => {
    try {
        const prompt=`Generate a full overwiew guide for a amazon product with details as a general user based on this product link: ${link}`
