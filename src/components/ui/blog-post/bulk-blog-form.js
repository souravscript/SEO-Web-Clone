...
//             <div className="mb-6">
//                 <h2 className="text-xl font-semibold text-gray-800">Bulk Blog Form</h2>
//                 <p className="text-gray-600">Add keywords and titles for your blog posts.</p>
//             </div>
...
//                                 {...register(`blogs[${index}].mainKeyword`, {
//                                     required: "Main Keyword is required",
//                                     onChange: (e) =>
//                                         updateEntryHandler(field.id, "mainKeyword", e.target.value),
//                                 })}
...
//                             />
//                             {errors?.blogs?.[index]?.mainKeyword && (
//                                 <span className="text-red-500 text-xs">
//                                     {errors.blogs[index].mainKeyword.message}
//                                 </span>
//                             )}
//                         </div>
...
//                                     onChange: (e) => updateEntryHandler(field.id, "title", e.target.value),
//                                 })}
